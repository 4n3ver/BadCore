...
[<assembly: AssemblyTitleAttribute("BadCore.Tests")>]
[<assembly: AssemblyProductAttribute("BadCore")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "BadCore.Tests"
    let [<Literal>] AssemblyProduct = "BadCore"
